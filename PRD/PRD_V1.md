...
| Role | Les & Ekskul – Pendaftaran | Les & Ekskul – Transaksi | Jurnal Guru | Jadwal Guru |
|---|---|---|---|---|
| **Kepala Sekolah** | Lihat semua | Lihat laporan (read-only) | Lihat & balas semua thread | Lihat semua jadwal |
| **TU** | Input & kelola pendaftaran | Input transaksi, ajukan laporan untuk approval | – | – |
| **Bendahara** | – | Approve laporan harian & bulanan | – | – |
...
- **ekstrakurikuler** — id, nama, biaya, kuota, tahun_ajaran_id (FK), pengajar_id (FK → pengajar_ekskul)
...
erDiagram
    ...
    EKSTRAKURIKULER }o--|| PENGAJAR_EKSKUL : "diajar oleh"
...
**Data yang Dimiliki:** `pendaftaran_les_ekskul`, `transaksi_pembayaran`, snapshot laporan harian/bulanan, pengaturan tutup buku

**Dependency:** hanya ke data master bersama (siswa, kelas, orang tua, guru, ekstrakurikuler, les_tambahan, pengajar_ekskul) — tidak ada dependency ke 2 modul lain

**Kasus Khusus:** siswa berhenti/masuk tengah bulan, pindah ekstra, anak guru bayar 50%, uang ekstra dialihkan ke uang buku (lihat A6 #2), ortu tidak kirim bukti transfer
...
**Masukan Dari Bu Yuricha:**  
- `Bikin Timeline Pengerjaan 3 Bulan` untuk tracking pekerjaan.
- Pelaporan setiap 2 minggu sekali. (meeting pada hari senin, jam 3 sore)
- File pendukung masukkan ke dalam drive, lalu diisi.
- Lembar konsultasi KP, itu per bimbingan per file (Bryan - Bimbingan 1 - 07092026 - KP), diakhir dijadikan pdf/docx lalu insert ttd. Boleh juga pakai 1 file, tapi bikin beda lembar
- 